...
data = pd.read_excel("/Users/mac/Google_drive/academic/georgia_tech/class_spring_2019/ISYE6501/week12_advanced_model/assignment/data/diet.xls",header=0) # read all data
